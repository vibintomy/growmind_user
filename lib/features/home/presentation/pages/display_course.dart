...
class DisplayCourse extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: BlocBuilder<PurchasedBloc, PurchasedState>(
          builder: (context, state) {
            if (state is PurchasedLoaded) {
              ...
              final isPurchased = purchasedCourses
                  .any((course) => course.userId == id.toString());
            ...
            return double.tryParse(coursePrice) != null &&
